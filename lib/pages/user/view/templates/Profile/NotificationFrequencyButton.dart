...
class NotificationFrequencyButton extends StatefulWidget {
  ...
  const NotificationFrequencyButton({Key? key, required this.primaryTitle, required this.secondaryTitle, required this.onPressed, required this.isSelected}) : super(key: key);
  @override
