...
class Projects {
  DataProjectTest dataProject = DataProjectTest();
  ...
  List<ProjectModel> listFormalProjects() {
    return dataProject.getListFormalProjects();
  }

  /* Creates and returns the list of all solidarity projects. */
  List<ProjectModel> listSolidarityProjects() {
    return dataProject.getListSolidarityProjects();
  }

  /* Creates and returns the list of the favorite solidarity projects. */
  List<ProjectModel> listFavoriteSolidarityProjects() {
    return dataProject.getListFavoriteSolidarityProjects();
  }

  /* Creates and returns the list of the finished projects for formal projects. */
  List<ProjectModel> listFinishedFormalProjects() {
    return dataProject.getListFinishedFormalProjects();
  }

  List<ProjectModel> listRunningFormalProjects() {
    return dataProject.getListRunningFormalProjects();
  }
/// ///////////////////////////////////////////////////////////
}